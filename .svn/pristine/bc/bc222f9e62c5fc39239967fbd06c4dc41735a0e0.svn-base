<template>
	<div class="dir" id="dir">
		...
		<form id="formID" action="" method="post">
			...
			<el-autocomplete class="inline-input" v-model="proj" :fetch-suggestions="querySearch" placeholder="请输入内容" @select="getProjId" :props='{value:"name",label:"name"}'></el-autocomplete>
			...
			<el-date-picker v-model="dateValue" type="date" placeholder="选择日期" :picker-options="pickerOptions0">
			</el-date-picker>
		   ...
		   <el-upload
			...
			<!--<div class="choosenOne">
			  ...
			  <el-select id="dzb" placeholder="请输入邀请人" multiple filterable v-model="choosenAddress" multiple>
			    <el-option
