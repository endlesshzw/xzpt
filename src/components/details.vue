	    ...
	    <div style="width: 1200px; margin: 0 auto;">
		    ...
		    <div style="padding-top: 16px;">
		    	...
		    	<div style="display: inline-block;">&nbsp;
		    		<el-button v-if="applyId()" type="primary" @click="cancelApply" style="padding: 3px 5px;">取消参与</el-button>
		    		<el-button v-else type="primary"  @click="apply" style="padding: 3px 5px;">我要参与</el-button>
		    	</div>
		    	<ul class="personUl">
...
//				this.uploadurl = "http://long.xiaoqunei.cn/eleUpload?token=" + this.fileToken + "&client=html5&name=" + this.fileName + "&size=" + this.fileSize;
